...
import { DataTable } from "@/components/incentive-pay/data-table"
import { type IncentivePay } from "@/components/incentive-pay/columns"
...
// Sample incentive pay data (empty array to show empty state)
const incentivePayRecords: IncentivePay[] = []

export function IncentivePaySection() {
          ...
          <div className="flex items-center justify-between">
            <div>
              <div className="flex items-center gap-2 text-sm text-muted-foreground mb-2">
                ...
                <span>Incentive Pay</span>
              </div>
              <CardTitle>New Incentive Pay</CardTitle>
            </div>
    ...
    <Card>
      <CardHeader>
        <div className="flex items-center justify-between">
          <div>
            ...
            <CardTitle>Incentive Pay</CardTitle>
          </div>
      ...
      <CardContent>
        <div className="space-y-4">
          ...
          <DataTable
            data={incentivePayRecords}
            search={search}
            onSearchChange={setSearch}
            onView={(incentive) => {
              // TODO: Implement view
              console.log("View", incentive)
            }}
            onEdit={(incentive) => {
              // TODO: Implement edit
              console.log("Edit", incentive)
            }}
            onDelete={(incentive) => {
