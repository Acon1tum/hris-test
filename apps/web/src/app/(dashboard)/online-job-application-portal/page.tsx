...
const moduleData = MODULES.ONLINE_JOB_APPLICATION

export default function OnlineJobApplicationPortalPage() {
      ...
      <div className="flex flex-col gap-4 py-4 md:gap-6 md:py-6">
        <div className="px-4 lg:px-6">
          <Card>
            ...
            <CardContent>
              <p className="text-muted-foreground">Job application portal module content coming soon...</p>
            </CardContent>
          </Card>
        </div>
      </div>
