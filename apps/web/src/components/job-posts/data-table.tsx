...
import { JobPost, getColumns } from "./columns"
...
export function DataTable({
  ...
  // Filter data based on search, status, and employment type
  const filteredData = React.useMemo(() => {
    return data.filter((item) => {
      ...
      const matchesEmploymentType =
        ...
        item.employmentType.toLowerCase() === employmentTypeFilter.toLowerCase()

      return matchesSearch && matchesStatus && matchesEmploymentType
    })
  }, [data, search, statusFilter, employmentTypeFilter])
